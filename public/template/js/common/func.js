...
$.fn.disabledElement = function(){
    ...
    $(this).each(function(){
        $(this).get(0).ontouchstart = absorbEvent_;
        $(this).get(0).ontouchmove = absorbEvent_;
        $(this).get(0).ontouchend = absorbEvent_;
        $(this).get(0).ontouchcancel = absorbEvent_;
    });
