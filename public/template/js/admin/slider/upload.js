...
$(document).ready(function(){
      ...
      success: function(response){
        ...
        if(!response.status){
          ...
          if($(instance).attr('data-type') == 'normal'){
            ...
            $('input[name="imgPath"]').val(response.root_media + response.files[0].thumbnailPath);
          } else {
            console.log('another');
            console.log( response.files[0].thumbnailPath);
  ...
  $('.drop-area[data-type="normal"]').css({backgroundImage: 'url('+$('input[name="imgPath"]').val()+')'});
 ...
 * Created by rikkei on 07/11/2017.
 */
